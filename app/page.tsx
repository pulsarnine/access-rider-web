...
export default function Home() {
  ...
  return (
    <>
      ...
      <FeaturesTitle />
      <div
        className="absolute left-1/2 top-1/2 w-52 lg:w-[400px]
      h-52 lg:h[400px]"
      ></div>
      <div className="p-8 max-w-3xl mx-auto">
        ...
        {/* <div className="flex flex-col gap-8 mt-10">
          ...
          >
            ...
            doloremque ducimus harum enim. Aut temporibus ullam sunt id error
            nulla.
          </p>
          <p
            style={{
          ...
          >
            ...
            blanditiis cumque ex cum enim necessitatibus natus temporibus
            maiores eligendi ratione minus nisi, ea, fuga facilis aliquid veniam
