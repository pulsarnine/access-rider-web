...
export default function UserInput() {
  ...
  const [supportPronouns, setSupportPronouns] = useLocalStorage(
    "supportPronouns",
    "",
  );
  ...
  const [emergencyPronouns, setEmergencyPronouns] = useLocalStorage(
    "emergencyPronouns",
    "",
  );
  const [emergencyPhone, setEmergencyPhone] = useLocalStorage(
    "emergencyPhone",
    "",
  );
  const [emergencyEmail, setEmergencyEmail] = useLocalStorage(
    "emergencyEmail",
    "",
  );
  const [otherInfo, setOtherInfo] = useLocalStorage("otherInfo", "");
  const [supportingInfo, setSupportingInfo] = useLocalStorage(
    "supportingInfo",
    "",
  );
  ...
  return (
    <>
      ...
      />
      <p>
        You could write a small introduction, who you are and your
        profession/practice.
        <br />
        If you wish include a disclosure about your condition(s) and essential
        things to know about working with you.
        <br />
      ...
      />
      <p>
        Getting to your regular place of work, trips, needing a close/accessible
        parking space.
        <br />
        Travel away including: beaks after travel away, international travel and
        accommodation – whether you need a support worker, access requirements
        for accommodation.
      </p>
      <br />
